...
title: "Tabgha | Política de privacitat"
titleSection: "POLÍTICA DE PRIVACITAT DEL SITIO WEB"
---

https://www.tabgha.es/
## I. POLÍTICA DE PRIVACITAT I PROTECCIÓ DE DADES
Respectant el que estableix la legislació vigent, Tabgha Xiringuito Solidari Portals Nous (d'ara endavant, també Lloc Web) es compromet a adoptar les mesures tècniques i organitzatives necessàries, segons el nivell de seguretat adequat al risc de les dades recollides.
...
El responsable del tractament de les dades personals recollides a Tabgha Xiringuito Solidari Portals Nous és: , proveïda de NIF: R0700192H i inscrit a: amb les dades registrals següents: , el representant del qual és: Tabgha Xiringuito Solidari Portals Nous (d'ara endavant, Responsable del tractament ). Les vostres dades de contacte són les següents:
...
Les categories de dades que es tracten a Tabgha Xiringuito Solidari Portals Nous són únicament dades identificatives. En cap cas, no es tracten categories especials de dades personals en el sentit de l'article 9 del RGPD.

### Base legal per al tractament de les dades personals
La base legal per al tractament de les dades personals és el consentiment. Tabgha Xiringuito Solidari Portals Nous es compromet a demanar el consentiment exprés i verificable de l'Usuari per al tractament de les seves dades personals per a un o diversos fins específics.
...
Les dades personals només seran retingudes durant el temps mínim necessari per als fins del seu tractament i, en tot cas, únicament durant el termini següent: 23 mesos, o fins que l'Usuari sol·liciti la seva supressió.
...
L'Usuari té sobre Tabgha Xiringuito Solidari Portals Nous i podrà, per tant, exercir davant del Responsable del tractament els següents drets reconeguts al RGPD i la Llei Orgànica 3/2018, de 5 de desembre, de Protecció de Dades Personals i garantia dels drets digitals:

- Dret d'accés: És el dret de l'Usuari a obtenir confirmació de si Tabgha Xiringuito Solidari Portals Nous està tractant o no les vostres dades personals i, en cas afirmatiu, obtenir informació sobre les vostres dades concretes de caràcter personal i del tractament que Tabgha Xiringuito Solidari Portals Nous hagi realitzat o realitzi, així com, entre una altra, de la informació disponible sobre l'origen d'aquestes dades i els destinataris de les comunicacions realitzades o previstes.
...
- Dret d'oposició: És el dret de l'Usuari que no es dugui a terme el tractament de les seves dades de caràcter personal o se'n cessi el tractament per part de Tabgha Xiringuito Solidari Portals Nous.
...
Així, doncs, l'Usuari podrà exercitar els seus drets mitjançant comunicació escrita dirigida al Responsable del tractament amb la referència "RGPD-https://www.tabgha.es/", especificant:
...
Adreça postal: Carrer Miguel dels Santos Oliver, s/n

Correu electrònic: info@tabgha.es

### Enllaços a llocs web de tercers
El Lloc Web pot incloure hipervincles o enllaços que permeten accedir a pàgines web de tercers diferents de Tabgha Xiringuito Solidari Portals Nous, i que per tant no són operats per Tabgha Xiringuito Solidari Portals Nous. Els titulars d'aquests llocs web disposaran de les seves pròpies polítiques de protecció de dades, i ells mateixos seran, en cada cas, responsables dels seus propis fitxers i de les pròpies pràctiques de privadesa.
